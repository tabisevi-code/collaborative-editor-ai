...
The local forgot-password flow uses a one-time reset token shown directly inside the local environment
instead of integrating an email provider. This preserves the reset lifecycle without adding external
service complexity.
