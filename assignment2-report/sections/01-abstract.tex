...
Several design decisions were driven by reliability under coursework conditions. Passwords are securely
...
contracts, and setup scripts so that evaluators can clone the project, configure environment variables,
run the system locally, and inspect the final implementation without relying on undocumented steps.
