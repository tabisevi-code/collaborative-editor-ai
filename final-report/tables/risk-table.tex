...
Backend and realtime configuration drift & Medium & Auth/session failures and invisible data mismatch across services & Shared root scripts, shared realtime secret, shared SQLite path, Docker Compose configuration & Restart with \texttt{npm run dev:clean} and verify health/docs endpoints before demo \\
