...
\textit{Note: this appendix belongs to the historical Assignment 1 report package kept in the repository for traceability. The current Assignment 2 runnable system is documented separately in the repository root and the Assignment 2 docs.}
...
\begin{enumerate}
  \item Run \texttt{npm run dev:all} from the repository root.
  ...
  \item Export the document and show Swagger/OpenAPI at \texttt{http://localhost:8000/docs/}.
\end{enumerate}
