...
\begin{enumerate}
  ...
  \begin{itemize}
    \item \texttt{npm run demo:reset} (auto-detects LM Studio when available), or
    \item \texttt{AI\_PROVIDER=lmstudio npm run demo:reset} to force the LM Studio path.
  \end{itemize}
\end{enumerate}
